	...
	<body>
		...
		<div id="LoginBox">
		   ...
		   <span><input type="password" id="PasswordInput" style="border:1px solid #999999;" placeholder="请输入密码" name="LoginPassword"></span>
			...
			<div style="position:relative;top:7%;margin-left:25%"><text id="JumpText" style="color:#808080;width:15%">还没有账号？请</text><a id="RegistText" href="../JSP/Register.jsp">注册</a></div>
			<div style="position:relative;top:15%;left:62%"><text id="JumpToPwReset" style="color:#808080;width:25%;margin-left:-40%">忘记密码？<a href="PwReset.jsp" style="margin-left:5%">点击这里！</a></text></div>
		</div>
		</form>
	</body>
</html>       